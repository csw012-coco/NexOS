...
#define BOOTX_UEFI_MAX_MENU_ENTRIES 8u
#define BOOTX_UEFI_LABEL_MAX 64u
#define BOOTX_UEFI_MENU_POLL_USEC 10000u
#define BOOTX_UEFI_MARQUEE_STEP_USEC 250000u
#define BOOTX_UEFI_MARQUEE_PAUSE_FRAMES 8u
#define BOOTX_UEFI_MARQUEE_MIN_OVERFLOW 4u
...
struct boot_config {
    char label[BOOTX_UEFI_LABEL_MAX];
...
static struct boot_config g_menu_entries[BOOTX_UEFI_MAX_MENU_ENTRIES];
    ...
    while (cur < end && entry_index < BOOTX_UEFI_MAX_MENU_ENTRIES) {
        ...
        if (key_equals(key_start, (uint32_t)(key_end - key_start), "LABEL")) {
            ...
            copy_span(g_menu_entries[entry_index].cmdline,
                   ...
                   g_menu_entries[entry_index].module_count < BOOTX_MAX_MODULES) {
