...
static uint32_t make_fb_color(const struct janus_console_info *console, uint8_t r, uint8_t g, uint8_t b) {
    uint32_t value = 0;
...
static void fb_put_pixel(const struct janus_console_info *console, uint32_t x, uint32_t y, uint32_t color) {
...
static void fb_fill_rect(const struct janus_console_info *console, uint32_t x, uint32_t y,
...
static void draw_framebuffer_demo(const struct janus_boot_info *boot_info) {
    const struct janus_console_info *console = &boot_info->console;
