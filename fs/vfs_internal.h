...
enum {
    ...
    VFS_PROC_CPUINFO = 13u,
    VFS_PROC_FILESYSTEMS = 14u,
    VFS_PROC_BLOCK = 15u,
    VFS_PROC_PARTITIONS = 16u,
    VFS_PROC_CMDLINE = 17u,
    VFS_PROC_VERSION = 18u,
    VFS_PROC_FB = 19u,
    VFS_PROC_INTERRUPTS = 20u,
    VFS_PROC_TTY = 21u,
    VFS_EVENT_ROOT = 1u,
    VFS_EVENT_TIMER = 2u,
